...
@node(
    name="JSON URL Knowledge Base",
    category="agno_knowledge",
    icon="braces.svg",
    has_enabled_switch=False,
)
class JsonUrlKnowledge(ServiceNode):
    """
    JSON URL-based knowledge base for Agno agents.
    """
    ...
    urls: list[Union[str, dict[str, Any]]] = NodeVariableSettings(
        ...
        has_in=True,
        default=[],
        info="List of JSON URLs with optional metadata.",
    )
