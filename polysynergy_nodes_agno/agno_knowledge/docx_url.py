...
@node(
    name="DOCX URL Knowledge Base",
    category="agno_knowledge",
    icon="brain.svg",
    has_enabled_switch=False,
)
class DocxUrlKnowledge(ServiceNode):
    ...
    urls: list[Union[str, dict[str, Any]]] = NodeVariableSettings(
        label="DOCX/DOC URLs",
        has_in=True,
        dock=dock_dict(key_label="URL", value_label="Metadata",
                       info="List of DOCX/DOC URLs with optional metadata."),
        default=[],
    )
