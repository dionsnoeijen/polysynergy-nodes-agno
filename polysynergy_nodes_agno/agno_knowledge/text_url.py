...
@node(
    name="Text URL Knowledge Base",
    category="agno_knowledge",
    icon="file-text.svg",
    has_enabled_switch=False,
)
class TextUrlKnowledge(ServiceNode):
    """
    Plain text (.txt) URL-based knowledge base for Agno agents.
    """
    ...
    urls: list[Union[str, dict[str, Any]]] = NodeVariableSettings(
        ...
        dock=dock_dict(
            ...
            info="List of text (.txt) URLs with optional metadata."
        ),
        default=[],
    )
