...
class AgnoTeam(ServiceNode):
    ...
    async def _setup(self):
        ...
        return model, memory, settings, debug_level, mode, tool_info_list, member_info_list

    async def _create_team(self):
        model, memory, settings, debug_level, mode, tool_info_list, member_info_list = await self._setup()
